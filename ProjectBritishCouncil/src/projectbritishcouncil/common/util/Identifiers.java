...
public final class Identifiers  // Identifiers for use in CommonInstancesClass
{
    ...
    public static String CURRENT_USER = "currently_logged_in_user";
    
    
    //////// File Chunk Identifiers
    //-------------------------------
    //// File Chunk Identifiers, must be unique (well they pretty much all should be...)
        public static final String COMMONS_FILE_CHUNK = "commonFileChunk_asjfoiasd2";
        public static final String ABDULLAH_FILE_CHUNK = "abdullah_file_chunk_jwwdf@#sdf";
        public static final String SAMIRA_FILE_CHUNK = "samira_apus_precious_file_chunk_which_is_very_smol";
